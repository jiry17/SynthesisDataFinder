 ...
 * @param srcthe ByteBuffer to copy from
 * @param startOfFieldthe position of the buffer at which the field starts
 * @return a copy of the data between startOfField and the buffer position
 * before invokation
 * @throws IllegalArgumentExceptionif startOfField is somewhere after src.position()
 */
